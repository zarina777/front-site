...
const Login = () => {
  ...
  return (
    <Container className="p-10 flex flex-col items-center justify-center bg-blue-100 h-[90vh]">
      <h1 className="text-white text-5xl font-extrabold mb-12">Log in</h1>
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 px-10 sm:px-20 justify-around  w-full rounded-lg">
